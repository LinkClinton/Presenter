    ...
    public abstract class InputAssemblerStage
    {
        ...
        public Buffer VertexBuffer
        {
            ...
            set
            {
                ...
                Engine.ID3D11DeviceContext.InputAssembler.SetVertexBuffers(0,
        ...
        public Buffer IndexBuffer
        {
            ...
            set
            {
                ...
                Engine.ID3D11DeviceContext.InputAssembler.SetIndexBuffer(indexBuffer.ID3D11Buffer,
        ...
        public PrimitiveType PrimitiveType
        {
            ...
            set
            {
                ...
                Engine.ID3D11DeviceContext.InputAssembler.PrimitiveTopology = (SharpDX.Direct3D.PrimitiveTopology)primitiveType;
            }
        }
